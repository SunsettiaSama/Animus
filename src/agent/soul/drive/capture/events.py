...
BOUNDARY_KINDS = frozenset(
    {
        CaptureKind.user_text,
        CaptureKind.agent_utterance,
        CaptureKind.agent_deferred,
        CaptureKind.scene_enter,
        CaptureKind.proactive_open,
        CaptureKind.proactive_delivered,
        CaptureKind.ambiguity_detected,
        CaptureKind.clarify_resolved,
        CaptureKind.close,
    }
)
