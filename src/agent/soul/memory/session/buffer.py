...
from agent.soul.memory.graph.networks.experience_block import ExperienceBlock, ExperienceKind
...
from agent.soul.memory.session.integrate import build_session_raw_text, integrate_session_dialogue
from agent.soul.memory.session.types import DialogueCompressionBlock, SessionBlockRecord, SessionBufferState
...
class SessionMemoryBuffer:
    ...
    def ingest_session_block(
        ...
        *,
        ...
        actor = (interactor_id or session_id).strip()
    ...
    def _integrate_session(
        ...
        *,
        ...
        merged = self.social._merge_neighborhood(
            self.social.ensure_core(state.interactor_id),
            node,
        )
