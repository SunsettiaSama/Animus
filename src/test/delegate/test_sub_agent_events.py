...
_simple_stubs = {
    ...
    "agent.scheduler.timeline":       dict(TimelineStore=MagicMock()),
    ...
    "agent.react.memory.long_term.init":        dict(make_memory=MagicMock()),
    "agent.react.memory.long_term.memory":      dict(LongTermMemory=MagicMock()),
    "agent.react.memory.medium_term.memory":    dict(RecentHistoryMemory=MagicMock()),
    "agent.react.memory.memory":                dict(Step=MagicMock()),
    "agent.react.memory.milestone.init":        dict(make_milestone=MagicMock()),
    "agent.react.memory.milestone.memory":      dict(MilestoneMemory=MagicMock()),
    "agent.react.memory.processor":             dict(MemoryProcessor=MagicMock(), MemoryResult=MagicMock()),
    ...
    "agent.react.persona":         dict(PersonaManager=MagicMock()),
